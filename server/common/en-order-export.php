...
namespace EnDayrossOrderExport;

/**
 * Get and save settings.
 * Class EnDayrossOrderExport
 * @package EnDayrossOrderExport
 */
if (!class_exists('EnDayrossOrderExport')) {
    ...
    class EnDayrossOrderExport
    {
        ...
        public function en_orders_ids()
        {
            try {
                ...
                if ($en_orders_ids_flag != 'executed') {
                    ...
                    $date_to = date('Y-m-d');
                    $orders_arr = wc_get_orders(array(
        ...
        public function en_orders_sending($orders, $en_orders_ids)
        {
            ...
            $response = \EnDayrossCurl\EnDayrossCurl::en_dayross_sent_http_request(EN_DAYROSS_ORDER_EXPORT_HITTING_URL, $post_data, 'POST', 'Export Order');
