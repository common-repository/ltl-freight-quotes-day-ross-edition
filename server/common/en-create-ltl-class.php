...
namespace EnDayrossCreateLTLClass;

/**
 * Create class in shipping classes.
 * Class EnDayrossCreateLTLClass
 * @package EnDayrossCreateLTLClass
 */
if (!class_exists('EnDayrossCreateLTLClass')) {
    ...
    class EnDayrossCreateLTLClass
    {
        ...
        /**
         * Hook for call.
         * EnDayrossCreateLTLClass constructor.
         */
