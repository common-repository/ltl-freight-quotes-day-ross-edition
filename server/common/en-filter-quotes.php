...
namespace EnDayrossFilterQuotes;

use EnDayrossVersionCompact\EnDayrossVersionCompact;

/**
 * Rates according selected rating method.
 * Class EnDayrossFilterQuotes
 * @package EnDayrossFilterQuotes
 */
if (!class_exists('EnDayrossFilterQuotes')) {
    ...
    class EnDayrossFilterQuotes
    {
        ...
        static public function average_rate()
        {
            ...
            $rate_list = EnDayrossVersionCompact::en_array_column(self::$quotes, 'cost');
