...
namespace EnDayrossVersionCompact;

/**
 * Get valid php dericated function.
 * Class EnDayrossVersionCompact
 * @package EnDayrossVersionCompact
 */
if (!class_exists('EnDayrossVersionCompact')) {
    ...
    class EnDayrossVersionCompact
    {
        ...
        static public function en_array_column($data, $key)
        {
            ...
            if (empty($arr_length) || !$old_version)
                return $columns;
