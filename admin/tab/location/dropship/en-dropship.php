...
namespace EnDayrossDropshipTemplate;

use EnDayrossWarehouse\EnDayrossWarehouse;

if (!class_exists('EnDayrossDropshipTemplate')) {

    class EnDayrossDropshipTemplate
    {
        ...
        {
            $en_heading = $en_data = [];
            $en_dropship_list = EnDayrossWarehouse::get_data(['location' => 'dropship']);
            ...
            <p><?php _e('Locations that inventory specific items that are drop shipped to the destination. Use the products settings
