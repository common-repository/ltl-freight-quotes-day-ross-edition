...
namespace EnDayrossOrderRates;

/**
 * Order page rates.
 * Class EnDayrossOrderRates
 * @package EnDayrossOrderRates
 */
if (!class_exists('EnDayrossOrderRates')) {
    ...
    class EnDayrossOrderRates
    {
         ...
         * EnDayrossOrderRates constructor.
         */
        public function __construct()
        {
            add_action('wp_ajax_nopriv_en_dayross_admin_order_quotes', array($this, 'en_dayross_admin_order_quotes'));
            add_action('wp_ajax_en_dayross_admin_order_quotes', array($this, 'en_dayross_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_dayross_admin_order_quotes()
        {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnDayrossShippingRates();
