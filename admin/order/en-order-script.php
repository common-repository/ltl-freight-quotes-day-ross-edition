...
namespace EnDayrossOrderScript;

/**
 * Script for send ajax request.
 * Class EnDayrossOrderScript
 * @package EnDayrossOrderScript
 */
if (!class_exists('EnDayrossOrderScript')) {
    ...
    class EnDayrossOrderScript
    {
         ...
         * EnDayrossOrderScript constructor.
         */
        public function __construct()
        {
            add_action('admin_print_scripts', [$this, 'en_dayross_order_script'], 50);
        }

        public function en_dayross_order_script()
        {
            global $post;
            ?>
                    ...
                    let data =
                        {
                            ...
                            'action': 'en_dayross_admin_order_quotes'
                        };
                    jQuery.ajax({
                        type: "POST",
                        url: ajaxurl,
