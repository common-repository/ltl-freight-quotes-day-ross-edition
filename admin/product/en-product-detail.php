...
namespace EnDayrossProductDetail;

use EnDayrossWarehouse\EnDayrossWarehouse;

/**
 * Add and show simple and variable products.
 * Class EnDayrossProductDetail
 * @package EnDayrossProductDetail
 */
if (!class_exists('EnDayrossProductDetail')) {
    ...
    class EnDayrossProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnDayrossProductDetail constructor.
         */
        public function __construct()
        {
            ...
            if (!has_filter('En_Plugins_dropship_filter') &&
                ...
                $this->en_dayross_check_if_woo_payment_and_subscription_plugin_installed();
        ...
        {
            return EN_DAYROSS_DECLARED_TRUE;
        }
        ...
        {
            $dropship = EnDayrossWarehouse::get_data(['location' => 'dropship']);
            $en_dropship_list = [];
        ...
        public function en_product_fields_arr()
        {
            ...
            $en_product_fields = apply_filters('en_dayross_add_product', $en_product_fields);
         ...
         */
        public function en_dayross_check_if_woo_payment_and_subscription_plugin_installed()
        {
            $all_plugins = apply_filters('active_plugins', get_option('active_plugins'));
