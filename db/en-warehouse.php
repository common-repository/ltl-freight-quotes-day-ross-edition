...
namespace EnDayrossWarehouse;

/**
 * Generic class to handle warehouse data.
 * Class EnDayrossWarehouse
 * @package EnDayrossWarehouse
 */
if (!class_exists('EnDayrossWarehouse')) {
    ...
    class EnDayrossWarehouse
    {
        ...
        /**
         * Hook for call.
         * EnDayrossWarehouse constructor.
         */
        ...
        public function create_table($network_wide = null)
        {
            ...
            if (is_multisite() && $network_wide) {
                foreach (get_sites(['fields' => 'ids']) as $blog_id) {
                    ...
                    $dayross_origin_markup = $wpdb->get_row("SHOW COLUMNS FROM " . $en_table_name . " LIKE 'origin_markup'");
                    if (!(isset($dayross_origin_markup->Field) && $dayross_origin_markup->Field == 'origin_markup')) {
